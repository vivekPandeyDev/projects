package com.vivek.commerce.exception;

import java.util.HashMap;
import java.util.Map;

import com.vivek.commerce.response.ApiError;
...
public class GlobalExceptionAdvice {
    ...
    ApiError<String> badCredentialsException(BadCredentialsException ex){
        return new ApiError<>(false,HttpStatus.UNAUTHORIZED,Map.of("error" , ex.getMessage()),"Invalid credentials try with valid username or password");
    }
