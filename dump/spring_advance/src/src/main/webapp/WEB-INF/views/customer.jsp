			...
			<div class="col-12">
				...
				<div class="card card-body">
					<form:form class="row g-3 mt-2 needs-validation"
						action="/spring_advance/customer/add" method="post"
						modelAttribute="customerDto">
						<h2>Personal Information</h2>
						<div class="col-md-6">
							<label class="form-label required"><spring:message code="label.gender" /></label>
						...
						<div class="col-md-6">
							<label for="validationServer02" class="form-label required"><spring:message code="label.firstName" /></label>
						...
						<div class="col-md-6">
							<label for="validationServer03" class="form-label required"><spring:message code="label.lastName" /></label>
						...
						<div class="col-md-6">
							<label class="form-label"><spring:message code="label.nationality" /></label>
							<form:select class="form-select" aria-label="gender selection"
								path="nationality">
						...
						<div class="col-md-6">
							<label for="dateOfBirth" class="form-label required"><spring:message code="label.dob" /></label>
							<!--            is-invalid-->
						...
						<div class="col-md-6">
							<label class="form-label"><spring:message code="label.address.houseNo" /></label>
						...
						<div class="col-md-6">
							<label class="form-label"><spring:message code="label.address.country" /></label>
						...
						<div class="col-md-6">
							<label class="form-label"><spring:message code="label.address.state" /></label>
						...
						<div class="col-md-6">
							<label class="form-label"><spring:message code="label.address.city" /></label>
						...
						<div class="col-md-12">
							<label class="form-label"><spring:message code="label.address.address1" /></label>
						...
						<div class="col-md-12">
							<label class="form-label"><spring:message code="label.address.address2" /></label>
