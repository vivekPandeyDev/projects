			...
			<div class="col-12">
				<div class="card shadow-lg">
					<div id="form-header"
						...
						UserForm</div>
					<div class="card-body">
						<form:form action="/mvc/user/register" method="post" modelAttribute="userInfo">
							<div class="row">
								...
								<div class="col-6 form-group">
									<label class="p-1 fs-5">Designation:</label> <form:input
										class="input form-control" path="dob"
										placeholder="enter your dob"/>
								</div>
								<div class="col-6 form-group">
									<label class="p-1 fs-5">Hobbies:</label>
									<div class="form-control row gap-3 fs-5">
									 <form:checkboxes class="m-2"  path="hobbies" items="${hobbiesList}" />
								    </div>
								</div>

								<div clas="col-6 form-group">
								    <label class="p-1 fs-5">Preferred Location:</label>
                                        <form:select class="form-control text-center" path="preferredHolidayLocation">
								...
								<div clas="col-6">
								    ...
								    <div class="form-control">
								         <label class="p-1 fs-5 form-label">Male:</label>
                                        <form:radiobutton path="gender" value="male"/>
                                        <label class="p-1 fs-5 form-label">Female:</label>
