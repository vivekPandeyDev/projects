...
<link rel="stylesheet" href="css/505.css">
<link rel="stylesheet" type="text/css"
	href="<c:url value='/resources/css/505.css' />">
...
<body>
	<div class="main-error-page">
		...
		<h3 class="error-title text-center">
			Code:
			<%=exception.getMessage()%>
		</h3>
		<div>
			<h2 class="error-subtitle text-center">
				Woops! <br>Sorry for the inconvenience :(  <br>
				<br> <a class="btn btn-danger btn-lg"
					href="http://localhost:8080/final_brd">Home Page</a>
			</h2>
